...
const logreportRegistrationSchema = Schema({
    userid : { type : Schema.Types.ObjectId , ref : 'User'},
    reportid : { type : Schema.Types.ObjectId , ref : 'ReportRegistration'},
...
module.exports = mongoose.model('logReportRegistration' , logreportRegistrationSchema);