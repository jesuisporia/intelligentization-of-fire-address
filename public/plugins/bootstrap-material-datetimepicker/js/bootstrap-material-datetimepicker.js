(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'fa', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'لغو', okText: 'تایید', clearText: 'پاک کردن', nowText: 'زمان الان', switchOnClick: false};
      this.params = $.fn.extend(this.params, options);

      this.name = "dtp_" + this.setName();
      this.$element.attr("data-dtp", this.name);

      console.log(this.params.format)
