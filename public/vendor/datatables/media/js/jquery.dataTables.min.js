...
oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای برای نمایش وجود ندارد",sInfo:"نمایش _START_ از _END_ کل _TOTAL_ داده ",sInfoEmpty:"نمایش 0 از 0 کل 0 داده ",sInfoFiltered:"(فیلتر شده از  _MAX_ تمام داده ها)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نماش _MENU_ کل",sLoadingRecords:"در حال بارگزاری...",sProcessing:"در حال پردازش...",sSearch:"جست و جو:",sSearchPlaceholder:"برای جست و جو نام آتش نشان را وارد کنید",sUrl:"",sZeroRecords:"چیزی برای نمایش پیدا نشد"},oSearch:h.extend({},
